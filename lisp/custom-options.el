(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (annotate-depth anzu auctex auto-complete buffer-move counsel csharp-mode deadgrep dynamic-ruler easy-kill-extras edit-at-point fic-mode fold-this highlight-escape-sequences highlight-symbol indent-guide json-mode loccur magit magit-gitflow msvc noccur occur-x omnisharp powershell restart-emacs ripgrep tfs use-package web-mode ws-butler xah-find)))
